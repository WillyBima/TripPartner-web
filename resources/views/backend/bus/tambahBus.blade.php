  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/MenuBus">Menu Bus</a></li>
        <li class="active">Form Tambah Data Bus</li>
      </ol>
    </section>
      ...
      <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="{{url('/MenuBus/tambahData')}}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">

                <div class="form-group">
                  <label>Nama PO Bus</label>
                  <select class="form-control" name="nama_po">
                    @foreach($po as $po)
                ...
                <div class="form-group">
                  ...
                  <select name="jenis_bus" class="form-control" placeholder="Pilih Jenis Bus">
