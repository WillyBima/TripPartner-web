...
<head>
  ...
  <title>AdminTripPartner | Menu Order</title>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12" style="margin-top: 30px;">
              <table id="order" class="table table-bordered text-center">
                <thead>
                  <tr>
                    <th>Id</th>
                    <th>Nama Lengkap</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @endif
                    <td>
                      <a href="{{url('/MenuOrder/editOrder/'.$o->id)}}" class="btn btn-primary" style="width: 100%;"><span class="fa fa-edit color-white"><span></a>
                    </td>
                    <td>
