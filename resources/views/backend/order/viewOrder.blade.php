...
<head>
  ...
  <title>AdminTripPartner | Detail Order</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="/dashboardAdmin"><i class="fa fa-tachometer-alt"></i> Home</a></li>
        <li><a href="/MenuOrder">Menu Order</a></li>
            ...
            <form role="form" action="" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <p class="">{{$o->alamat_jemput}}</p>
                </div>
                <div class="form-group">
                  <label>Alamat Tujuan</label>
                  <p class="">{{$o->alamat_tujuan}}</p>
                </div>
                <div class="form-group">
                  <label>Tanggal Pergi</label>
                  <p class="">{{$o->tanggal_pergi}}</p>
                </div>
                <div class="form-group">
