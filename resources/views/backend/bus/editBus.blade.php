  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Form Edit Data Bus</li>
      </ol>
    </section>
      ...
      <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            ...
            @foreach($bus as $b)
            <form role="form" action="{{url('/MenuBus/updateData/'.$b->id)}}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <option value="{{$b->id_po}}">{{$b->nama_po}} (Dipilih)</option>
                  @foreach($po as $pobus)
                  <option value="{{$pobus->id}}">{{$pobus->nama_po}}</option>
                  @endforeach
                  </select>
                </div>
                <div class="form-group">
