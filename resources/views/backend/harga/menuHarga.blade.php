...
<head>
  ...
  <title>AdminTripPartner | Menu Harga</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="rounded" style="background: #fff; margin-top: 20px;">
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <a href="{{url('/MenuHarga/createHarga')}}" class="btn" role="button" style="background-color: #f96d01; color: #ffffff; margin-bottom: 20px;"><span class="fa fa-plus color-white"><span> Tambah Data</a>
              <table id="Harga" class="table table-bordered text-center">
                <thead>
                  <tr>
                    <th>Id</th>
                    <th>Nama Bus</th>
