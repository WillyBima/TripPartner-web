  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/MenuBus">Menu Harga</a></li>
        <li class="active">Form Edit Data Harga</li>
      </ol>
    </section>
            ...
            <form role="form" action="{{url('/MenuHarga/updateHarga/'.$k->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$h->nama_bus}}" name="nama_bus" placeholder="">
                </div>
                ...
                <div class="form-group">
                  <label>Harga</label>
                  <input type="text" class="form-control" value="{{$h->harga}}" name="harga" placeholder="">
                </div>
              </div>
